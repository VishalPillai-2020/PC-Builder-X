...
function redirect_div2(){
    window.location="fastest_gaming_pc.html";
}
function redirect_div3(){
    window.location="Fastest_workstation.html";
}
...
function build_diy() {
    ...
    window.location = "Processor_select.html";
}
...
function PAMD(){
    localStorage.setItem("AMD", 1);
    if (localStorage.getItem("build_yourself") == 1){
...
function showcomponents(){
    ...
    if(localStorage.getItem("budget") == 30000 && localStorage.getItem("build_yourself") == 1 &&  localStorage.getItem("use") == "Gaming" && localStorage.getItem("AMD") == 1){
